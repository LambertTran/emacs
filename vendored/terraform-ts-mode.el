...
(define-derived-mode terraform-ts-mode prog-mode "Terraform"
  ...
  ;; eglot event logging / sync-connect / autoshutdown are global eglot
  ;; settings, not terraform-specific, and are configured once in
  ;; features/fe-completion.el instead of here.
  ...
  (setq-local treesit-font-lock-feature-list '((comments)
					       ...
					       (builtin brackets delimiters expressions operators interpolation conditionals)
					       ()))
